...
class CACENET(nn.Module):
    ...
    def __init__(self,
        ...
        self.tri_loss = TripletLoss(num_classes, margin, normalize_feature=True)
    ...
    def compute_loss(self, output, target):
        ...
        losses, losses_names = [], []
        loss, cls_tp, cls_prob = self.ce_loss_ls(logit, target)
        losses.append(loss)
        ...
        tri_loss, distanceScore_tri, distance_an_tri, distance_ap_tri = self.tri_loss(f, target)
        ...
        return losses, losses_names, cls_tp, cls_prob, distanceScore_tri, distance_an_tri, distance_ap_tri